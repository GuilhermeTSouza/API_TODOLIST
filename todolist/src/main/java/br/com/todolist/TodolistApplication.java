...
@Bean
	CommandLineRunner criarTarefasFakes(TodoRepository todoRepository){
		return args -> {
			todoRepository.deleteAll();

			Todo todo1 = new Todo("Configurar JDK", "Preciso apreder a configurar o jdk corretamente", StatusEnum.NOT_STARTED);
